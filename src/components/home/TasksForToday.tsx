import { Card, CardContent, Typography, Divider, Stack, Box, Button, Tooltip, Modal, List, ListItem, ListItemIcon, ListItemText, Paper, Chip } from '@mui/material';
...
export default function TasksForToday({ displayedPercent: initialDisplayedPercent, pulse: initialPulse, progressTarget: initialProgressTarget }: TasksForTodayProps) {
